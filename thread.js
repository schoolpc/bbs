...
dbref.on('child_added', function (snapshot) {
    ...
    if(type === "resu"){
        ...
        var newElement = $("<il><div class='card my-1 p-3' style='display:inline-block;'>" + username + " | <time class='time'>" + time + "</time><p id='resu'>" + message + "</p><a class='name' href='thread.html?t="+ ID +"'>元スレ</a></div><p class='clear_balloon'></p></il>");
